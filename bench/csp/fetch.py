"""Fetch XCSP3 CSP (decision) competition instances.

    python fetch.py --year 25 --limit 30
    python fetch.py --year 24 --mini            # MiniCSP track
    python fetch.py --year 25 --limit 0         # whole CSP track
"""
import argparse
import os
import sys
...
if __name__ == "__main__":
    ...
    fetch_xcsp("CSP", args.year, args.out, limit=args.limit, mini=args.mini, repo_root=repo)
