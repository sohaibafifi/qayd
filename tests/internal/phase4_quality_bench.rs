...
use qayd::engines::ls::lists::solve_collection_capped_profiled;
...
#[test]
#[ignore = "deterministic phase 4 quality benchmark"]
fn phase4_quality_benchmark() {
    ...
    let iterations = 400;
    let (solution, metrics) = solve_collection_capped_profiled(&model, 41, &stop, iterations, None, &mut |_| {});
    eprintln!(
        "phase4-bench feasible={} objective={} candidates={} elapsed_ms={:.3}",
        solution.feasible,
